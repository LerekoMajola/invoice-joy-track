...
export function CompanySwitcher() {
  ...
  // Single company, multi-company disabled → static display only
  if (!canAddMore && companies.length <= 1) {
    return (
      <div className="flex items-center gap-2 bg-card border border-border rounded-xl px-3 py-1.5 shadow-card h-auto">
