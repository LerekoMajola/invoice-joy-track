...
export const testimonials: Testimonial[] = [
  ...
  {
    quote: "The Workshop module made our shop run like clockwork. Job cards, parts tracking, and invoicing — all in one place. Our turnaround time dropped by 40%.",
    initials: "LK",
    name: "Lebohang Khesa",
    role: "Workshop Owner",
    product: "BizPro",
  ...
  {
    quote: "Fee collection used to be a nightmare. The School module gives us full visibility on who's paid, who owes, and automates reminders. Parents love it too.",
    initials: "MN",
  ...
  {
    quote: "We rent out 200+ items and the Hire module tracks every single one. Returns, deposits, availability — it's all seamless now.",
    initials: "TR",
  ...
  {
    quote: "The Guesthouse module helped us go from pen-and-paper bookings to a fully digital operation. Occupancy is up 25% since we started.",
    initials: "KS",
    name: "Keketso Sello",
  ...
  {
    quote: "Managing 30 vehicles was chaos before the Fleet module. Now we track fuel, maintenance, and costs per vehicle effortlessly.",
    initials: "BT",
    name: "Bokang Thamae",
